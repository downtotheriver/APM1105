...
estimated_miles = truncate(miles, 2)
...
print("Average Pace (time per mile in minutes and seconds): ", estimated_miles, "miles in", converted_minutes, "minutes and", converted_seconds, "seconds")
